...
spa.avtr = (function () {
	...
	onTapNav = function ( event ){
		...
		console.log(" in svtr onTapNav event.elem_target : " + event.elem_target, " $target : " + $target);
	...
	onSetchatee = function ( event, arg_map ){
		...
		console.log(" in avtr onSetchatee this : " + this);
	...
	onListchange = function( event ){
		...
		console.log(" in avtr onListchagen this : "+ this,  "$(this) : " +$nav);
	...
	initModule = function( $container ){
		...
		$container
			.bind( 'utap', 				onTapNav )
			.bind( 'udragstart.udrag',  onHeldstartNav )
			.bind( 'udragmove.udrag',   onHeldmoveNav )
			.bind( 'udragend.udrag',    onHeldendNav )
